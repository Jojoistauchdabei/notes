...
`.goodnotes`-Dateien werden komplett client-seitig dekodiert (ZIP → Protobuf → Apple-LZ4 → TPL-Strokes) und als neues Dokument in die Bibliothek übernommen: Handschrift-Strokes (Farbe, Breite, Marker), platzierte Bilder, Titel, alle Seiten. v1-Limits: Shapes, getippte Textboxen und PDF-Hintergründe werden nicht übernommen.
